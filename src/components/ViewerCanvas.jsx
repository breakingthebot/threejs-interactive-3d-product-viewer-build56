 ...
 * @param {boolean} props.showStats - Whether WebGL performance benchmark stats are rendered.
  ...
  return (
    <div className="viewer-canvas-container">
      ...
      >
        ...
        {/* WEBGL PERFORMANCE STATS PROFILER */}
        <PerformanceStats showStats={showStats} />
